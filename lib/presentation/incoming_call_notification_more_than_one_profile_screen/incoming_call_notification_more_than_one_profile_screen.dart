import '../incoming_call_notification_more_than_one_profile_screen/widgets/group252_item_widget.dart';
import '../incoming_call_notification_more_than_one_profile_screen/widgets/group253_item_widget.dart';
import 'controller/incoming_call_notification_more_than_one_profile_controller.dart';
import 'models/group252_item_model.dart';
import 'models/group253_item_model.dart';
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        Group252ItemModel model = controller
                                            .incomingCallNotificationMoreThanOneProfileModelObj
                                            .value
                                            .group252ItemList[index];
                                        return Group252ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
                                  ...
                                  Obx(
                                    () => ListView.builder(
                                      ...
                                      itemCount: controller
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        Group253ItemModel model = controller
                                            .incomingCallNotificationMoreThanOneProfileModelObj
                                            .value
                                            .group253ItemList[index];
                                        return Group253ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
